...
const PaymentMethod = ({
  ...
  return payment_methods ? (
    <div className=" w-full bg-[#FEFEFE] rounded-lg py-6 md:py-8  px-4 md:px-9 ">
            ...
            <button
              className={
                paymentMethod?.id !== method.id
                  ? ' min-w-[100px] h-5 px-6 py-4 border border-default_gray flex items-center justify-between rounded-lg mr-3 mb-3  transition duration-700    hover:border-primary hover:text-primary'
