...
const Listing_Filter = ({ hidden_category, reset_filter }) => {
  ...
  return (
    <div className=" md:w-4/6 lg:w-[75%] xl:w-5/6 overflow-hidden relative flex items-center gap-3">
                    ...
                    item?.show_in_filter && (
                      <ul className="" key={Math.random()}>
                        <li
                          ...
                          onClick={(e) =>
                            toggleChildren(e, item.id, item.values)
                          }
                        >
                          <span>{item.name}</span>
                          {item?.values?.length > 0 ? (
                            ...
                            <input
                              ...
                              onChange={() =>
                                filter_by_attribute_value(item.id)
                              }
                            />
                          )}
                        </li>
