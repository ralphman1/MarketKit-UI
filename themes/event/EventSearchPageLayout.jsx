...
import { getSearchListings, searchSelector } from '../../store/feature/search';
import { useDispatch } from 'react-redux';
import CustomLoading from '../../components/Shared/Loading/CustomLoading';
import ReactPaginate from 'react-paginate';
import SearchListingsItem from '../../components/SearchItem/SearchListingsItem';
import Filter from '../../components/SearchItem/Filter';
    ...
    <>
      ...
      <div>
        <div className="mb-4 flex items-center justify-between ">
          <ExploreFilter hidden_category={false} reset_filter={reset_filter} />
          <ListingsView
                      ...
                      {router?.query?.start_at && (
                        <div className="  h-[100%] lg:col-span-2 pt-3">
                          <GoogleMap
                            ...
                            center={{
                              lat: coordinates_listings[0]?.coordinates
                                ?.latitude,
...
export default EventSearchPageLayout;
